...
# msvc-wine overlay: generate_cmake_config is forced off in the triplet
# (see cmake/triplets-wine/x64-windows-static-md.cmake) because the meson.build
# generates it via an ad-hoc `cmake --system-information` call that misdetects
# cl.exe when cross-compiling from Linux under Wine. That means
# tomlplusplusConfig.cmake never gets written, so skip the fixup steps that
# depend on it.
if(EXISTS "${CURRENT_PACKAGES_DIR}/share/tomlplusplus/tomlplusplusConfig.cmake")
